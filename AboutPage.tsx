...
const AboutPage: React.FC = () => {
  useEffect(() => {
    ...
    document.title = "About Us - mosagraphic";
    if (metaDesc) metaDesc.setAttribute('content', "Learn about mosagraphic's mission to make visual information accessible, the technology behind our AI-powered OCR tool, and our commitment to user privacy.");
