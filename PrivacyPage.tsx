      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <article className="prose prose-invert prose-lg mx-auto text-gray-300 space-y-8">
          ...
          <div id="info-we-collect">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Information We Collect</h2>
          ...
          <div id="how-we-use">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">How We Use Your Information</h2>
          ...
          <div id="sharing-info">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Sharing Your Personal Information</h2>
            <p>
          ...
          <div id="adsense">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Google AdSense and Third-Party Advertising Disclosure</h2>
          ...
          <div id="your-rights">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Your Rights (GDPR and CCPA)</h2>
            <p>
          ...
          <div id="data-retention">
              <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Data Retention and Security</h2>
           ...
           <div id="gemini-api">
              <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Use of Google Gemini API and GDPR Compliance</h2>
          ...
          <div id="changes">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Changes</h2>
            <p>
          ...
          <div id="contact">
            <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-purple-400 mb-4">Contact Information</h2>
            <p>
